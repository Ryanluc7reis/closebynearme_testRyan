  ...
  return (
    <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
      <Typography sx={{ mr: 2, display: 'flex', color: 'text.secondary' }}>
        ...
        {`by`}
        <Typography sx={{ ml: 1 }} target='_blank' href='https://walink.co/92e348' component={StyledCompanyName}>
          DesitionDev
        </Typography>
      </Typography>
      {hidden ? null : (
        <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', '& :not(:last-child)': { mr: 4 } }}>
          ...
          <Typography target='_blank' component={LinkStyled} href='https://wa.link/6v0fxr'>
            Soporte
          </Typography>
        </Box>
      )}
