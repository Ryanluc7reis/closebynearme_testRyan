...
const CONFIG = {
    ...
    JWT_REFRESHTOKEN_SECRET: process.env.JWT_REFRESHTOKEN_SECRET || 'refreshSecret',
    ...
    REDIS_NAME: process.env.NODE_ENV === 'production'
        ? (0, base64_1.Base64UnEncript)(process.env.REDIS_NAME) || 'ha-redis'
