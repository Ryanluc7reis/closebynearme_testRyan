    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                {
                    name: location_entity_1.Location.name,
                    schema: location_entity_1.LocationSchema,
                },
            ]),
        ],
        providers: [locations_resolver_1.LocationsResolver, locations_service_1.LocationsService],
